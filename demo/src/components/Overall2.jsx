...
function Overall2(props) {
  ...
  return (
    <div className='eblist'>
        <div className="ebimg">
        <NavLink to={`/details2/${props.item.id}`}><img src={props.item.image} /></NavLink>
      </div>
      <div className="ebrsk">
        <div className="stars">
          <ReactStars
        ...
        <div className="elek">{props.item.type}</div>
...
let t=(s)=>s;
export default connect(t)(Overall2);