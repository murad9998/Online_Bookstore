...
function Selfh(props) {
  return (
    <div className='selfbooks'>
      <Menu/>
      {/* <div className='selffimg'><img src="https://www.bradford.gov.uk/media/5080/health.png" /></div> */}
      <div className="kateqrisk">
        ...
        <div className="ebook">
          {props.ebook.filter((t)=>t.id<=72).map((a) => (
...
let t=(s)=>s;
export default connect(t)(Selfh);