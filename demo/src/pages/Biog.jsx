...
function Biog(props) {
  return (
    <div className='biogbook'>
      <Menu/>
      {/* <div className='biogimg'><img src="https://www.mordego.com/wp-content/uploads/2018/08/Top-10-Biographies-Books.png" /></div> */}
      <div className="kateqrisk">
        ...
        <div className="ebook">
          {props.books.filter((t)=>t.id>=76 || t.id==75 || t.id==74 || t.id<=3).map((a) => (
