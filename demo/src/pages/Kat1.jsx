...
function Kat1(props) {
  return (
    <div className="kategor2">
      <Menu />
      <div className="titdesa">
        <div>
          <h1>Rəqəmsal audio kitablar</h1>
        </div>
        <div className="audiline"></div>
        <div className="risktit">
          <div>
            <h4>Audio</h4>
          </div>
          <div>
      ...
      <div className="kateqrisk">
        ...
        <div className="ebook">
          {props.books.filter((b)=>b.id>=11 && b.id<=23).map((a) => (
            <Overall key={a.id} item={a} />
          ))}
        </div>
      </div>
      <div className="people">
        <div className="peopletit"><h1>Müştərilər haqqımızda nə düşünür ?</h1></div>
        <div className="peoplemain">
          <div className="mainpep1">
            <div className="peph2"><h2>Kitabları tez tapın</h2></div>
            <div className="peph3"><h3>Bu sayt əladır! Mən müntəzəm pulsuz audio kitab dinləyicisiyəm və hər zaman bir neçə kliklə tez nəyisə tapa bilirəm.</h3></div>
            <div className="pepbez">
              <div className="pepbezimg"><img src="https://www.digitalbook.io/static/media/testimonial-1.eeff1579.png" /></div>
              <div className="peprealbez">
                <div className="realbezh4"><h4>Əliyev Orxan</h4></div>
                <div className="realbezh4"><h4>Marketoloq</h4></div>
              </div>
            </div>
          </div>
          <div className="mainpep1">
            <div className="peph2"><h2>Təmiz sadə dizayn</h2></div>
            <div className="peph3"><h3>Təmiz və sadə dizaynı sevirəm. Sayt onlayn audio pleyer və şəxsi kitab rəfi kimi əla xüsusiyyətlərə malikdir.</h3></div>
            <div className="pepbez">
              <div className="pepbezimg"><img src="https://www.digitalbook.io/static/media/testimonial-2.88157e17.png" /></div>
              <div className="peprealbez">
                <div className="realbezh4"><h4>İsmayılova Nigar</h4></div>
                <div className="realbezh4"><h4>Qrafik dizayner</h4></div>
              </div>
            </div>
          </div>
          <div className="mainpep1">
            <div className="peph2"><h2>Böyük pulsuz resurs</h2></div>
            <div className="peph3"><h3>İngilis dili müəllimi kimi bu, mənim tələbələrim üçün əla mənbədir. Çoxsaylı mənbələrdən minlərlə pulsuz elektron kitabla.</h3></div>
            <div className="pepbez">
              <div className="pepbezimg"><img src="https://www.digitalbook.io/static/media/testimonial-3.071000be.png" /></div>
              <div className="peprealbez">
                <div className="realbezh4"><h4>Rzayeva Fidan</h4></div>
                <div className="realbezh4"><h4>İngilis dili müəllimi</h4></div>
              </div>
            </div>
          </div>
        </div>
