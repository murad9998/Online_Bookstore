...
function Favor(props) {
  return (
    <div className='kategor2'>
      <Menu/>
      {props.favs.length==0? <div>
        <div className='bosb'>
        <div className='basbfl'>
          <div className='iiid'><img src="https://icons.iconarchive.com/icons/hopstarter/soft-scraps/256/Button-Favorite-icon.png" /></div>
          <div className='bosyaz'><h1>Sevimli məhsullarınız bu hissədə göstəriləcək...</h1></div>
        </div>
      </div>
      <Gift/>
      <Recommend/>
...
let t=(s)=>s;
export default connect(t)(Favor);